...
public class RealTimeWebService {
	
	private static List<StationData> stationDataList;
	private static StationData[] stationDataArray;
	 ...
	 * @throws Exception
	 */
	public static StationData[] getStationData(String stationType,String stationApiCode) {

		if(stationType.equals("BusEireann")){
			stationDataArray = getBusEireannStationData(stationApiCode);
		} else if(stationType.equals("DublinBus")){
			stationDataArray = getDublinBusStationData(stationApiCode);
		} else if(stationType.equals("IrishRail")){
			stationDataArray = getIrishRailStationData(stationApiCode);
		} else if(stationType.equals("Luas")){
			stationDataArray = getLuasStationData(stationApiCode);
		} else if(stationType.equals("JJKavanagh")){
			stationDataArray = getJJKavanaghStationData(stationApiCode);
		}
	 ...
	 * @throws Exception
	 */
	public static StationData[] getBusEireannStationData(String apiCode) {
		...
		stationDataArray = stationDataList.toArray(new StationData[stationDataList.size()]);
	 ...
	 * @throws Exception
	 */
	public static StationData[] getDublinBusStationData(String apiCode){
	 ...
	 * @throws Exception
	 */
	public static StationData[] getIrishRailStationData(String apiCode) {
	 ...
	 * @throws Exception
	 */
	public static StationData[] getJJKavanaghStationData(String apiCode) {
	 ...
	 * @throws Exception
	 */
	public static StationData[] getLuasStationData(String apiCode) {
